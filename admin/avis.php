...
<head>
    ...
    <style>
        .review-card:hover { border-color: #ef4444; transform: translateY(-2px); }
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6 md:p-12">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
                ...
                <div class="flex items-center gap-4 bg-white p-4 rounded-3xl shadow-sm border">
                    <div class="text-right">
                        ...
                        <p class="text-xl font-black text-gray-900">4.8 / 5</p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <div class="flex justify-between items-start mb-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 class="font-black text-gray-900 tracking-tight">Yassine Mansouri</h4>
                                    <p class="text-[10px] font-bold text-red-600 uppercase tracking-widest italic">Dacia Sandero</p>
                                </div>
                            </div>
                            <div class="flex star-active text-[10px] gap-1">
                                <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star star-inactive"></i>
                            </div>
                        </div>

                        <p class="text-gray-500 text-sm leading-relaxed italic mb-8">
                            "Véhicule très économique, propre à la remise des clés. L'agence de Casablanca est très pro. Je recommande sans hésiter."
                        </p>
                    </div>

                    <div class="flex justify-between items-center border-t border-gray-50 pt-6">
                        <span class="text-[10px] text-gray-300 font-bold uppercase italic">Posté le 01 Janv. 2026</span>
                        
                        <div class="flex gap-2">
                            <form action="../actions/toggle_avis.php" method="POST">
                                <input type="hidden" name="avis_id" value="1">
                                <button type="submit" class="flex items-center gap-2 px-4 py-2 bg-gray-50 text-red-400 rounded-xl text-[10px] font-black hover:bg-red-600 hover:text-white transition uppercase">
                ...
                <div class="bg-white p-8 rounded-[40px] shadow-sm border border-dashed border-gray-200 opacity-60 grayscale flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start mb-6">
                            <div class="flex items-center gap-4">
                                <div class="w-12 h-12 bg-gray-200 rounded-2xl flex items-center justify-center font-black text-gray-400 uppercase">AB</div>
                                <div>
                                    <h4 class="font-black text-gray-900 tracking-tight">Amine Benani</h4>
                                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest italic">Citroën C3</p>
                                </div>
                            </div>
                        ...
                        <p class="text-gray-400 text-sm leading-relaxed italic mb-8">
                            "Commentaire supprimé par l'administrateur car il ne respectait pas les règles."
                        </p>
                    </div>
                    <div class="flex justify-end pt-6 border-t border-gray-50">
                        <form action="../actions/toggle_avis.php" method="POST">
                            <input type="hidden" name="avis_id" value="2">
                            <button type="submit" class="px-4 py-2 bg-green-50 text-green-600 rounded-xl text-[10px] font-black hover:bg-green-600 hover:text-white transition uppercase">
